...
Button1 = Button(frame2, image=Rock, fg="Yellow", bg="Black", activebackground="Green",
                 command=lambda: startgame("rock"))
Button1.grid(row=2, column=1)

Button2 = Button(frame2, image=Paper, fg="Yellow", bg="Black", activebackground="Green",
                 command=lambda: startgame("paper"))
Button2.grid(row=2, column=2)

Button3 = Button(frame2, image=Scissor, fg="Yellow", bg="Black", activebackground="Green",
                 command=lambda: startgame("scissor"))
